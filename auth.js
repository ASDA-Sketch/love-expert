/**
 * 激活码认证模块 v29
 * 激活码存储在 Cloudflare Worker 中，前端不暴露 API Key
 * 前端只发送激活码到 Worker 代理验证，验证通过后存储激活码（不存 Key）
 */

// Cloudflare Worker API 代理地址
var API_PROXY_URL = 'https://love-expert.1421445437.workers.dev';
